 ...
 *
 */
public class PokemonEggGroupData {

	private PokemonEggGroup group1;
	private PokemonEggGroup group2;
	
	public PokemonEggGroupData( MemoryBuffer memory, int address ) {
		this.group1 = PokemonEggGroup.fromValue( memory.get( address ) );
		this.group2 = PokemonEggGroup.fromValue( memory.get() );
	}
	
	public PokemonEggGroup getGroup1() {
		return group1;
	}
	
	public PokemonEggGroup getGroup2() {
		return group2;
	}
}
