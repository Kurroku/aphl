 ...
 *
 */
public class PokemonBattleStatData {
	...
	public PokemonBattleStatData( MemoryBuffer memory, int address ) {
		this.hp = memory.get( address );
		this.attack = memory.get();
		this.defense = memory.get();
		this.spAttack = memory.get();
		this.spDefense = memory.get();
	}
