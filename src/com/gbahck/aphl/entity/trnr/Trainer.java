package com.gbahck.aphl.entity.trnr;

import static com.gbahck.aphl.entity.EntityType.TRAINER;

import com.gbahck.aphl.MemoryBuffer;
import com.gbahck.aphl.entity.Entity;
import com.gbahck.aphl.gfx.battl.TrainerBattleSprite;
...
public class Trainer extends Entity {
	...
	public Trainer( MemoryBuffer memory, int id ) {
		super ( TRAINER, true );
		this.id = id;
		this.memory = memory;
	}
	
	public TrainerBattleSprite getBattleSprite() {
		return new TrainerBattleSprite( memory, id );
	}
