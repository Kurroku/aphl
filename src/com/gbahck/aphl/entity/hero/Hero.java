...
import static com.gbahck.aphl.entity.EntityType.HERO;
...
public class Hero extends Entity {
	...
	public Hero( MemoryBuffer memory ) {
		super ( HERO, true );
		this.memory = memory;
	}
	
	public HeroSpawnData getSpawnLocation() {
		return new HeroSpawnData( memory );
	}
}
