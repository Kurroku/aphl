package com.gbahck.aphl.entity.hero;
...
public class HeroSpawnData {
	...
	public HeroSpawnData( MemoryBuffer memory ) {
		
	}
	
	public int getLevelBankId() {
		return 0;
	}
	
	public void setLevelBankId( int bankId ) {
		
	}
	
	public int getLevelEntryId() {
		return 0;
	}
	
	public void setLevelEntryId( int entryId ) {
