...
import com.gbahck.aphl.world.lvl.struct.LevelConnection;
/****************************************************************************\ 
 *                                                                           * 
 ...
 *
 */
public class LevelConnectionHeader {

	private Map< Integer, LevelConnection > connections = new HashMap< Integer, LevelConnection >();
	
	public LevelConnectionHeader( MemoryBuffer memory, int address ) {
		
	}
	
	public LevelConnection get( int id ) {
