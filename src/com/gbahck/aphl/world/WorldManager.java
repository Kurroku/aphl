...
import com.gbahck.aphl.world.map.WorldMap;
...
/**
 * highest abstraction point for world data.
 * 
...
public class WorldManager {
	...
	public WorldManager( MemoryBuffer memory ) {
		this.memory = memory;
	}
	
	public Level getLevel( int id ) {
		return new Level( memory, id );
	}
	
	public Level getLevel( int bankId, int mapId ) {
		return new Level( memory, bankId, mapId );
	}
	
	public WorldMap getWorldMap( int id ) {
		return new WorldMap( memory, id );
	}
}