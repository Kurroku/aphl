...
/**
 * highest abstraction for graphics data.
 * 
 * @author Phillip Groves
 */
public class GraphicsManager {
	
	public GraphicsManager( MemoryBuffer memory ) {
		
	}
	
	// TODO: bytes per pixel param
	public void getImage( int pixelDataAddress, int paletteDataAddress, int width, int height ) {
